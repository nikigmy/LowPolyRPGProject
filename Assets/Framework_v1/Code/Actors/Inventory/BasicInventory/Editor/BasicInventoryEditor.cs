...
//        if (EditorHelper.BoolField("Equip On Start", "Determines if we automatically equip the weaponset when the game start.", mTarget.EquipOnStart, mTarget))
//        {
//            mIsDirty = true;
//            mTarget._EquipOnStart = EditorHelper.FieldBoolValue;
//        }
...
//        if (EditorHelper.IntField("Quantity", "Amount of the item that exists.", rItem.Quantity, mTarget))
//        {
//            lIsDirty = true;
//            rItem.Quantity = EditorHelper.FieldIntValue;
//        }
...
//        if (EditorHelper.BoolField("Destroy On Store", "Determines if we destroy the object when it is stored or simply hide it. When we hide it, we don't re-create it when it is equipped again.", rItem.DestroyOnStore, mTarget))
//        {
//            lIsDirty = true;
//            rItem.DestroyOnStore = EditorHelper.FieldBoolValue;
//        }
...
//        if (EditorHelper.IntField("Current Form", "Value we'll set the Actor Core's 'Current Form' state value to when equipped. Use a value less than 0 to not set the state value.", rWeaponSet.DefaultForm, mTarget))
//        {
//            lIsDirty = true;
...
//        if (EditorHelper.BoolField("Instantiate & Equip", "Determines if we'll instantiate the item (if needed) and equip it at run-time.", rWeaponSetItem.Instantiate, mTarget))
//        {
//            lIsDirty = true;
