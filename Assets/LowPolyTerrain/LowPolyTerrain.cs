...
#pragma warning restore 0414
	...
	//	//{
	//	//	float x = i * TerrainSize / count;
	//	//	for (int j = 0; j <= count; ++j)
	//	//	{
	//	//		float z = j * TerrainSize / count;
	//	//		float height = Heightmap.SampleHeight(x, z);
	//	//		Gizmos.DrawRay(new Vector3(x, 0, z), new Vector3(0, height, 0));
	//	//	}
	//	//}
	...
	//			Ray ray = new Ray(new Vector3(x, startHeight, z), new Vector3(0, -1000, 0));

	//			RaycastHit hit = new RaycastHit();
	//			if (col.Raycast(ray, out hit, startHeight))
	//			//if (Physics.Raycast(ray, out hit, startHeight))
	//			{
	...
	//			}
	//			Gizmos.DrawCube(ray.GetPoint(hit.distance), Vector3.one * 10f);
	//		}
	//	}
	//}
}
