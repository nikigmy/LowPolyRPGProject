...
Version 1.3.2
- Fix collider issue when terrain size isn't a power of two
- Fix serialization of terrain heightmap data

Version 1.3.1
- Fix incorrect mirroring of terrain imported from raw16 files
