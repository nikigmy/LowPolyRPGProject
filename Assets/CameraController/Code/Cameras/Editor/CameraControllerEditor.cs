...
namespace com.ootii.Cameras
{
    ...
    public class CameraControllerEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (EditorHelper.Vector2Field("Camera Return Speed", "", mTarget.cameraReturnSpeed, mTarget))
            {
                mIsDirty = true;
                mTarget.cameraReturnSpeed = EditorHelper.FieldVector2Value;
            }
            ...
            if (EditorHelper.Vector3Field("Anchor Position Offset", "Offset from the transform that represents the true anchor.", mTarget.AnchorOffset, mTarget))
            {
                mIsDirty = true;
                mTarget.AnchorOffset = EditorHelper.FieldVector3Value;
            }

            //if (EditorHelper.Vector3Field("Anchor Rotation Offset", "Offset from the transform that represents the true anchor.", mTarget.AnchorRotationOffset, mTarget))
            //{
            //    mIsDirty = true;
            //    mTarget.AnchorRotationOffset = EditorHelper.FieldVector3Value;
            //}
