...
namespace com.ootii.Cameras
{
    ...
    public class TransitionMotor : CameraMotor
    {
        ...
        /// </summary>
        public bool _LimitToStart = false;
        ...
        public override bool OnInspectorGUI()
        {
            ...
            if (EditorHelper.BoolField("Only In Start", "Transition only activates while in the start motor.", LimitToStart, RigController))
            {
                lIsDirty = true;
            ...
            if (EditorHelper.TextField("Valid Actor Stances", "Comma delimited list of Actor Controller stances that the transition will work in. Leave empty to ignore this condition.", ActorStances, RigController))
            {
                lIsDirty = true;
